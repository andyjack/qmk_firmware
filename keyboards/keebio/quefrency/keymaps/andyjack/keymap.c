...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_65_with_macro(
    ...
    KC_F7,   KC_F8,   KC_LCTL, KC_LGUI, KC_LALT, AJ_FN1,  KC_SPC,                    _______, KC_SPC,  KC_RALT, KC_RCTL, AJ_FN2,  KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [_L1] = LAYOUT_65_with_macro(
    ...
    MUT_IN,  _______, _______, _______, _______, KC_UP,   _______, _______,          _______, _______, _______, _______, _______, _______, _______, _______, _______, \
