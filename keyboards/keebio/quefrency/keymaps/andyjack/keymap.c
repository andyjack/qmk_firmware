...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_65_with_macro(
    _______, KC_ESC,  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,             KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_DEL,  KC_BSPC, _______, \
    ...
    KC_F7,   KC_F8,   KC_LCTL, KC_LALT, KC_LGUI, AJ_FN1,  KC_SPC,                    _______, KC_SPC,  KC_RALT, KC_RCTL, AJ_FN2,  KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [_L1] = LAYOUT_65_with_macro(
    ...
    MUT_IN,  _______, RGB_TOG, RGB_MOD, _______, KC_UP,   _______, _______,          _______, _______, _______, _______, _______, _______, _______, _______, _______, \
    MUT_OUT, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______,          _______, _______, _______, _______, _______, _______, _______, _______, \
    MUT_MIC, _______, _______, _______, _______, _______, KC_BTN3, _______,          _______, _______, _______, _______, _______, _______, _______, _______, \
    SCN_LCK, _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT
  ),
