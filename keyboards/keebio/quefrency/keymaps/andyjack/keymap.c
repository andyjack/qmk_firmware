...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_65_with_macro(
    _______, KC_ESC,  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,             KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC, KC_BSPC, KC_DEL,  \
  ...
  [_L1] = LAYOUT_65_with_macro(
    ...
    MUT_IN,  _______, _______, _______, _______, KC_UP,   _______, _______,          _______, _______, _______, _______, _______, _______, _______, _______, KC_DEL, \
